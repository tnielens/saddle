...
object MatMath {
  ...
  /** Yields covariance matrix from input matrix whose columns are variable
    * observations
    *
    * @param mat
  ...
  /** Efficient block-based non-square matrix transpose that is sensitive to
    * cache line effects (destructive to out matrix)
    */
